...
const CrossSectionContent = () => {
  return (
    <div className="flex flex-col p-2 items-center justify-center md:items-start text-white max-w-[640px]">
      ...
      <p className="mb-5 text-center md:text-left">
        ...
        any ERC20, BSC20 or Solana (SPL) token. Our platform is the first of its kind, offering a
